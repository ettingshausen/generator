...
`useActualColumnNamesLowercase` and `useActualColumnNamesUppercase` were added in table properties in order to specify the case of the column name when generating the table structure.
